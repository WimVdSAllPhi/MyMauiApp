...
public static class MauiProgram
{
    ...
    public static MauiApp CreateMauiApp()
    {
        ...
        builder
            ...
            {
                // AddFont takes a required filename (first parameter) and an optional alias for
                // each font. When using these fonts in XAML you can use them either by filename
                // (without the extension,) or the alias.
